  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <h2 class="mb-4">Publicidades de Afiliado <?php echo $edit_emp->nom_empresa; ?></h2>
      </div>
    </div>
  </div>
          ...
          <div class="text py-3 pb-4 px-3 text-center">
            ...
            <div class="bottom-area d-flex px-3">
              <div class="m-auto d-flex">
                <a href="edit_mispublic.php?id=<?php echo $public->id_public; ?>" class="add-to-cart d-flex justify-content-center align-items-center text-center">
                  <span><i class="ion-ios-menu"></i></span>
                </a>
								<a href="estado_mispublic.php?id=<?php echo $public->id_public;?>" onClick="return confirm('Desea Activar la Publicacion <?php echo $emp->nom_servicio; ?>?')" class="buy-now d-flex justify-content-center align-items-center mx-1">
                  <span><i class="ion-ios-heart"></i></span>
                </a>
                <a href="delete_mipublic.php?id=<?php echo $public->id_public; ?>" onClick="return confirm('Desea Activar la empresa <?php echo $emp->nom_servicio; ?>?')" class="heart d-flex justify-content-center align-items-center ">
